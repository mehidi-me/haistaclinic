          ...
          <div className="container">
            ...
            <div className="grid-3">
              <div className="card">
                ...
                <p>
                  Minimally invasive technique where individual hair follicles
                  are extracted and implanted for natural-looking results. Ideal
                  for larger areas of hair loss with minimal scarring.
                </p>
              </div>
              <div className="card">
            ...
            <div className="grid-3">
              <div className="card">
                ...
                <p>
                  ...
                  (Depending on your hair loss pattern, additional details such
                  as close-up scalp images might be necessary).
                </p>
              </div>
              <div className="card">
                <h2>02</h2>
              ...
              <div className="card">
                ...
                <p>
                  Once you decide to proceed with the treatment, we will
                  schedule your appointment according to your preference and
                  arrange all necessary travel details, including arrival and
                  return dates, for you.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="grid-2 align-center mb-d">
              ...
              <div className="text-box">
                ...
                <h2>
                  No need to plan anything; we handle it all. Just arrive.
                </h2>
          ...
          <div className="container">
            ...
            <div className="cards">
              <div className="card-2 div1">
                ...
                <p>
                  Discover Haista Clinic’s tailored hair restoration solutions
                  in Turkey. We focus on your best results, not the highest
                  price. Our clients’ satisfaction and natural-looking outcomes
              ...
              <div className="card-2 div2">
                ...
                <p>
                  We believe in transparency and honesty. That’s why there are
                  no hidden fees or surprises with our loans.
                </p>
              </div>
              <div className="card-2 div3">
                ...
                <p>
                  ...
                  priority. Enjoy our post-operative care and support, helping
