...
export default function Home() {
  ...
  <main>
    ...
    <div className="mobile-hero">
      ...
      <Image loading="lazy" className="bg" width={0} height={0} priority={false} src="/images/haista-clinic7-768x7680.webp" alt="" />
      <div className="logos">
    ...
    <div className="container">
      <div className="content">
        <div className="fx-wrap">
          <h1 className="pc" style={bebasNeue.style}>Expert Hair Transplant in Turkey</h1>
          <div className="list">
