...
function Faq() {
  ...
  const questions = [
    ...
    { question: "What hair loss treatments do you offer besides transplantation?", answer: "We offer a range of hair loss treatments including  therapy, mesotherapy, and medical treatments tailored to your specific needs." },
