      ...
      <div className="container">
        <div className="content">
          <div className="fx-wrap">
            ...
            <div className="list">
              ...
              <h3>
                ...
                Competitive pricing with premium care
              </h3>
            </div>
            <p className="pc">
              Welcome to Turkey’s leading hair restoration clinic, serving
              clients since 2010. Our advanced hair transplant techniques and
          ...
          <div className="trust">
            <img
              loading="eager"
              src="/images/Lead-Capture-Hero-Star.webp"
              alt=""
            />
            <p>
              4.7/5 on <span>TrustPilot</span>
            </p>
          </div>
        </div>
        <div className="form">
          <img
            loading="lazy"
            className="overlay1"
            src="/images/Lead-Capture-Hero-Ornament.webp"
            alt=""
          />
          <img
            loading="lazy"
